...
class Helpers
{
  ...
  public static function localInsrtuctions($instructions){
      if(!isset($instructions)) return [];

      $loop_instructions = explode(',',$instructions);
      $instructs = [];
      foreach($loop_instructions as $loop_instruct):
        $instructs[] = __($loop_instruct);
      endforeach;
